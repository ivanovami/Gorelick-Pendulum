...
line, = ax.plot(r[0, 0], r[0, 1], color="darkred", markersize=0.5)
spring, = ax.plot(sp[:, 0], sp[:, 1], color="grey", markersize=0.2)
scat, = ax.plot(r[0, 0], r[0, 1], color="gold", marker="o", markersize=5)
ax.scatter(0, 0, color="darkgreen", s=10)
